...
export type ConditionSource =
  "setup" | "hardware" | "access" | "ui" | "runtime" | "constant" | "unknown";
export type VisibilityStatus =
  "visible" | "hidden" | "conditional" | "unknown" | "orphaned" | "broken";
...
export type FormChildren =
  RefPrompt | NumericPrompt | CheckBoxPrompt | OneOfPrompt | StringPrompt;
...
export type Scopes = {
  type: "Form" | "Numeric" | "CheckBox" | "OneOf" | "String" | ConditionKind;
  indentations: number;
  offset?: string;
}[];
